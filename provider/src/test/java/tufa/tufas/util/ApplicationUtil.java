...
public class ApplicationUtil {
    ...
    public Topology createAlienApplication(String applicationName, String topologyFileName) {
        ...
        String applicationId = applicationService.create("alien", applicationName, null, null, null);
        topology.setArchiveName(applicationId);
//        topology.set setDelegateType(Application.class.getSimpleName().toLowerCase());
